...
import {
  ArrowLeft, ArrowRight, Bot, Building2, Check, Edit3, FileText,
  Lock, Mail, ShieldCheck, Sparkles, Trash2, Upload, Zap,
} from 'lucide-react';
import { useNexus, STEP_SUBMITTED, inspectUpload } from '../context/AppContext';
...
export function CreateAccountStep({ vendor, onDone }) {
  ...
  // Two columns rather than one centred card. A lone 440px form in the middle
  // of a desktop viewport reads as an unfinished page, and the space is better
  // spent answering the question a supplier actually has at this moment  -
  // "who is asking, and what am I signing up to?"  -  than left empty.
  const steps = [
  ...
  return (
    <div className="auth-stage">
      ...
      <div className="auth-panel">
        ...
        <form className="auth-card" onSubmit={(event) => { event.preventDefault(); onDone(); }}>
    ...
    <section className="step-panel welcome-panel">
      <div className="welcome-head">
        <div className="welcome-head-text">
          <span className="wizard-badge"><ShieldCheck size={14} /> Application {vendor.id}</span>
