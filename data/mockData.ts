...
const field = (key: string, label: string, value: string, confidence: number, extra: Record<string, any> = {}) => ({
  key,
  label,
  value,
  confidence,
...
const resolvedField = (key: string, label: string, value: string, confidence: number, extra: Record<string, any> = {}) => ({
...
export const INITIAL_VENDORS = [
  ...
  },
  {
    id: 'VEN-3312',
    initials: 'AS',
    name: 'Leather Kings Co., Ltd.',
    shortName: 'Leather Kings',
    country: 'China',
    category: 'Handbags',
    contact: 'Anubhav Srivastav',
    email: 'anubhav@leatherkings.cn',
    owner: 'Aarav Mehta',
    baseRiskScore: 38,
    slaHours: 29,
    sla: '29h',
  ...
  },
  {
    ...
    shortName: 'Shanghai Textile',
    country: 'China',
    category: 'Apparels',
    contact: 'Wang Wei',
    email: 'contact@shanghaitextile.cn',
    owner: 'Priya Sharma (Vendor Executive)',
    baseRiskScore: 18,
    slaHours: 48,
    sla: '48h',
    stage: 'Verified',
    ...
    aiSummary: 'Leading cotton and silk textile supplier in Shanghai. All business registration, tax certificates, and OEKO-TEX eco-certifications verified with zero anomalies.',
    documents: [
      { id: 'doc-5501-tax', code: 'TAX', title: 'Business Registration & Tax Certificate', fileName: 'Shanghai_Tax_Registration.pdf', pageCount: 2, docTemplate: 'certificate', language: null, status: 'Verified', fields: [resolvedField('tax_registration_number', 'Tax registration no.', '91310000607211029X', 99)] },
      { id: 'doc-5501-bank', code: 'BANK', title: 'Bank Verification Letter', fileName: 'Bank_of_China_Letter.pdf', pageCount: 1, docTemplate: 'bank', language: null, status: 'Verified', fields: [resolvedField('account_holder_name', 'Account holder name', 'Shanghai Textile Co., Ltd.', 98)] },
      { id: 'doc-5501-coi', code: 'COI', title: 'Insurance Policy Certificate', fileName: 'PICC_Insurance_Policy.pdf', pageCount: 3, docTemplate: 'certificate', language: null, status: 'Verified', fields: [resolvedField('coverage_amount', 'General liability coverage', '$5,000,000 USD', 98)] },
    ],
  },
  {
    id: 'VEN-6202',
    initials: 'BG',
    name: 'Beijing Garments Ltd.',
    shortName: 'Beijing Garments',
    country: 'China',
    category: 'Outerwear & Jackets',
    contact: 'Li Na',
    email: 'compliance@beijinggarments.cn',
    owner: 'Priya Sharma (Vendor Executive)',
    baseRiskScore: 72,
    slaHours: 12,
    sla: '12h',
    ...
    finalStatus: null,
    hasSubmittedApplication: true,
    aiSummary: 'Outerwear manufacturer based in Beijing. Requires human verification on export license expiry date stamp.',
    documents: [
      { id: 'doc-6202-tax', code: 'TAX', title: 'Tax Certificate', fileName: 'Beijing_Tax_Cert.pdf', pageCount: 1, docTemplate: 'certificate', language: null, status: 'Verified', fields: [resolvedField('tax_registration_number', 'Tax registration no.', '91110000101928471M', 97)] },
      { id: 'doc-6202-bank', code: 'BANK', title: 'Bank Account Letter', fileName: 'ICBC_Bank_Letter.pdf', pageCount: 1, docTemplate: 'bank', language: null, status: 'Verified', fields: [resolvedField('account_holder_name', 'Account holder name', 'Beijing Garments Ltd.', 96)] },
      { id: 'doc-6202-coi', code: 'COI', title: 'Insurance Certificate', fileName: 'PingAn_Insurance.pdf', pageCount: 2, docTemplate: 'certificate', language: null, status: 'Needs Review', fields: [field('expiration_date', 'Insurance expiry date', '15 Nov 2026', 74)] },
    ],
  },
  {
    id: 'VEN-4109',
    initials: 'NF',
    name: 'Ningbo Fashion Group',
    shortName: 'Ningbo Fashion',
    country: 'China',
    category: 'Denim & Casualwear',
    contact: 'Zhang Min',
    email: 'info@ningbofashion.cn',
    owner: 'Elena Rostova',
    baseRiskScore: 24,
    slaHours: 36,
    sla: '36h',
    ...
    finalStatus: 'Approved',
    hasSubmittedApplication: true,
    aiSummary: 'Specialized denim exporter. Passed ISO 9001 and WRAP Gold audit verification.',
    documents: [
      { id: 'doc-4109-tax', code: 'TAX', title: 'Tax Certificate', fileName: 'Ningbo_Tax.pdf', pageCount: 1, docTemplate: 'certificate', language: null, status: 'Verified', fields: [resolvedField('tax_registration_number', 'Tax registration no.', '91330200712948123A', 99)] },
      { id: 'doc-4109-bank', code: 'BANK', title: 'Bank Letter', fileName: 'CBC_Bank_Letter.pdf', pageCount: 1, docTemplate: 'bank', language: null, status: 'Verified', fields: [resolvedField('account_holder_name', 'Account holder name', 'Ningbo Fashion Group', 99)] },
    ],
  },
  {
    id: 'VEN-1890',
    initials: 'HF',
    name: 'Hangzhou Fabrics Co., Ltd.',
    shortName: 'Hangzhou Fabrics',
    country: 'China',
    category: 'Silk & Fabrics',
    contact: 'Liu Yang',
    email: 'onboarding@hangzhoufabrics.cn',
    owner: 'Priya Sharma (Vendor Executive)',
    baseRiskScore: 45,
    slaHours: 72,
    sla: '72h',
    ...
    onboardingStep: 0,
    aiSummary: 'Vendor invited via secure onboarding link. Awaiting company profile creation and document pack submission.',
    documents: [
      { id: 'doc-1890-tax', code: 'TAX', title: 'Business Registration & Tax Certificate', fileName: '', pageCount: 0, docTemplate: 'certificate', language: null, status: 'Missing', fields: [] },
      { id: 'doc-1890-bank', code: 'BANK', title: 'Bank Verification Letter', fileName: '', pageCount: 0, docTemplate: 'bank', language: null, status: 'Missing', fields: [] },
      { id: 'doc-1890-coi', code: 'COI', title: 'Insurance Certificate', fileName: '', pageCount: 0, docTemplate: 'certificate', language: null, status: 'Missing', fields: [] },
    ],
  },
];
...
export const REQUEST_TEMPLATES = [
  {
    type: 'RISK_ACCEPTANCE',
    title: (v: any) => `Accept a lapsed chromium VI test for ${v.shortName}`,
  ...
  {
    type: 'RISK_ACCEPTANCE',
    title: (v: any) => `Waive the insurance floor for ${v.shortName}`,
  ...
  {
    type: 'AUTHORITY',
    title: (v: any) => `${v.shortName} exceeds the reviewer’s approval limit`,
    reason: (v: any) => `Evidence pack complete, all findings cleared. Residual risk ${v.riskScore} sits above the 70 ceiling a Compliance Manager may approve alone.`,
    detail: (v: any) => ({
      threshold: 'Compliance Manager may approve up to residual risk 70',
  ...
  {
    type: 'AUTHORITY',
    title: (v: any) => `First order with ${v.shortName} is above the reviewer’s value limit`,
  ...
  {
    type: 'REASSESSMENT',
    title: (v: any) => `Sanctions screening hit on ${v.shortName}`,
  ...
  {
    type: 'REASSESSMENT',
    title: (v: any) => `Financial deterioration at ${v.shortName}`,
  ...
  {
    type: 'ESCALATION',
    title: (v: any) => `Reviewer escalated ${v.shortName}`,
